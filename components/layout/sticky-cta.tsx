...
export function StickyCta() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-4 left-0 right-0 z-40 hidden px-4 md:block">
      <div className="pointer-events-auto mx-auto flex max-w-4xl items-center justify-between gap-4 rounded-full border border-line bg-panelElevated/95 px-5 py-3 shadow-panel backdrop-blur-xl">
        <div>
